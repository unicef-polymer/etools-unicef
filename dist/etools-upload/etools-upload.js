...
import { OfflineMixin } from './offline/offline-mixin.js';
import { getBlob, getFileUrl } from './offline/file-conversion.js';
import { storeFileInDexie } from './offline/dexie-operations.js';
import { getTranslation } from './utils/translate.js';
import { UploadsMixin } from './uploads-mixin.js';
    ...
    async _handleUpload() {
        ...
        this.uploadRawFile(this.rawFile, this.rawFile.name, this.setUploadProgress.bind(this))
            ...
            if (!this._cancelTriggered) {
                ...
                if ((err === null || err === void 0 ? void 0 : err.status) === 413) {
