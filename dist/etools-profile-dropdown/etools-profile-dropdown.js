 ...
 */
let EtoolsProfileDropdown = class EtoolsProfileDropdown extends LitElement {
    constructor() {
        super(...arguments);
        this.opened = false;
        this.readonly = true;
         ...
         */
        this.sections = [];
        this.profileDialogComponent = 'etools-user-profile-dialog';
        this.showEmail = false;
        this.hideAvailableWorkspaces = false;
...
__decorate([
    state()
], EtoolsProfileDropdown.prototype, "userProfileDialog", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], EtoolsProfileDropdown.prototype, "opened", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], EtoolsProfileDropdown.prototype, "readonly", void 0);
__decorate([
    property({ type: Array })
], EtoolsProfileDropdown.prototype, "sections", void 0);
__decorate([
    property({ type: Array })
], EtoolsProfileDropdown.prototype, "offices", void 0);
__decorate([
    property({ type: Object })
], EtoolsProfileDropdown.prototype, "users", void 0);
__decorate([
    property({ type: Object })
], EtoolsProfileDropdown.prototype, "profile", null);
__decorate([
    property({ type: String, attribute: 'profile-dialog-component' })
], EtoolsProfileDropdown.prototype, "profileDialogComponent", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-email', reflect: true })
], EtoolsProfileDropdown.prototype, "showEmail", void 0);
__decorate([
    property({ type: Boolean, attribute: 'hide-available-workspaces', reflect: true })
], EtoolsProfileDropdown.prototype, "hideAvailableWorkspaces", void 0);
__decorate([
    property({ type: Boolean })
], EtoolsProfileDropdown.prototype, "_loadingProfileMsgActive", void 0);
__decorate([
    property({ type: String })
], EtoolsProfileDropdown.prototype, "language", void 0);
EtoolsProfileDropdown = __decorate([
    customElement('etools-profile-dropdown')
], EtoolsProfileDropdown);
export { EtoolsProfileDropdown };
