...
let AppToolbar = class AppToolbar extends LitElement {
    constructor() {
        super(...arguments);
        this.responsiveWidth = '850px';
        this.language = '';
        this.headerColor = 'var(--header-bg-color)';
        this.hideAppMenu = false;
        this.hideLogo = false;
        this.hideAppSelector = false;
        this.textUnderLogo = '';
    }
    render() {
        return html `
...
], AppToolbar.prototype, "responsiveWidth", void 0);
__decorate([
    property({ type: String, attribute: 'language' })
], AppToolbar.prototype, "language", void 0);
__decorate([
    property({ type: Object })
], AppToolbar.prototype, "profile", void 0);
__decorate([
    state()
], AppToolbar.prototype, "headerColor", void 0);
__decorate([
    property({ type: Boolean, attribute: 'hide-app-menu' })
], AppToolbar.prototype, "hideAppMenu", void 0);
__decorate([
    property({ type: Boolean, attribute: 'hide-logo' })
], AppToolbar.prototype, "hideLogo", void 0);
__decorate([
    property({ type: Boolean, attribute: 'hide-app-selector' })
], AppToolbar.prototype, "hideAppSelector", void 0);
__decorate([
    property({ type: Boolean, attribute: 'text-under-logo' })
], AppToolbar.prototype, "textUnderLogo", void 0);
