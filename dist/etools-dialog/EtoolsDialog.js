...
export class EtoolsDialog extends DialogSpinnerMixin(LitElement) {
    ...
    constructor() {
        ...
        this.theme = 'default';
        this.confirmBtnVariant = 'primary';
    ...
    connectedCallback() {
        ...
        this.addEventListener('sl-after-hide', (event) => {
    ...
    getDialog() {
        var _a;
        return (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('#dialog');
    }
    scrollDown() {
        setTimeout(() => {
            var _a;
            ...
            if (d) {
                const scrollableContent = (_a = d.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('slot[part="body"]');
    ...
    triggerPopupOpenEvent(opened) {
        if (opened) {
            this.dispatchEvent(new CustomEvent('etools-dialog-opened', {
                detail: { value: opened },
                bubbles: true,
                composed: true
            }));
        ...
        if (!opened) {
            this.dispatchEvent(new CustomEvent('etools-dialog-closed', {
                detail: { value: opened },
                bubbles: true,
                composed: true
            }));
...
__decorate([
    property({ type: String })
], EtoolsDialog.prototype, "confirmBtnVariant", void 0);
__decorate([
