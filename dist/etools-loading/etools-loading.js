 ...
 */
let EtoolsLoading = class EtoolsLoading extends LitElement {
    set active(val) {
        this._active = val;
...
], EtoolsLoading.prototype, "active", null);
__decorate([
    property({ type: String, attribute: 'loading-text' })
], EtoolsLoading.prototype, "loadingText", void 0);
__decorate([
    state()
], EtoolsLoading.prototype, "defaultLoadingText", void 0);
__decorate([
    property({ type: String, attribute: 'language' })
], EtoolsLoading.prototype, "language", void 0);
EtoolsLoading = __decorate([
    customElement('etools-loading')
], EtoolsLoading);
export { EtoolsLoading };
