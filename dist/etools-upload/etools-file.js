 ...
 */
let EtoolsFile = class EtoolsFile extends CommonMixin(LitElement) {
    constructor() {
        super(...arguments);
        this.label = 'File attachment';
        this.files = [];
        this.multiple = false;
        this.disabled = false;
        this.uploadLabel = 'Upload File';
        this.readonly = false; //   observer: '_readonlyChanged'
        this.errorMessage = '';
        this.noFileAttachedMsg = 'No file attached';
        this.fileModel = null;
        this.useDeleteEvents = false;
        this.activateFileTypes = false;
        this.showUploadDate = false;
        this.showUploadBtnAbove = false;
        this.fileTypes = [];
        this.fileTypesLabel = 'File Type';
        this.hideDeleteBtn = false;
        this.showFilesContainer = false;
    }
    render() {
        // language=HTML
        return html `
    ...
    _getFileTypeStr(fileType) {
        ...
        const type = this._findInAvailableFileTypes(fileType);
        if (type) {
            return type.name;
        }
        return null;
    ...
    _findInAvailableFileTypes(fileType) {
        const type = this.fileTypes.filter(function (type) {
...
], EtoolsFile.prototype, "label", void 0);
__decorate([
    property({ type: Array })
], EtoolsFile.prototype, "files", void 0);
__decorate([
    property({ type: Boolean })
], EtoolsFile.prototype, "multiple", void 0);
__decorate([
    property({ type: Boolean })
], EtoolsFile.prototype, "disabled", void 0);
__decorate([
    property({ type: String })
], EtoolsFile.prototype, "accept", void 0);
__decorate([
    property({ type: String })
], EtoolsFile.prototype, "uploadLabel", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], EtoolsFile.prototype, "readonly", void 0);
__decorate([
    property({ type: String })
], EtoolsFile.prototype, "errorMessage", void 0);
__decorate([
    property({ type: String })
], EtoolsFile.prototype, "noFileAttachedMsg", void 0);
__decorate([
    property({ type: Object })
], EtoolsFile.prototype, "fileModel", void 0);
__decorate([
    property({ type: Boolean })
], EtoolsFile.prototype, "useDeleteEvents", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], EtoolsFile.prototype, "activateFileTypes", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], EtoolsFile.prototype, "showUploadDate", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], EtoolsFile.prototype, "showUploadBtnAbove", void 0);
__decorate([
    property({ type: Array })
], EtoolsFile.prototype, "fileTypes", void 0);
__decorate([
    property({ type: String })
], EtoolsFile.prototype, "fileTypesLabel", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], EtoolsFile.prototype, "hideDeleteBtn", void 0);
__decorate([
    property({ type: Object })
], EtoolsFile.prototype, "toastFitInto", void 0);
__decorate([
    property({ type: Boolean })
], EtoolsFile.prototype, "showFilesContainer", void 0);
__decorate([
    property({ type: Number })
], EtoolsFile.prototype, "changeFileIndex", void 0);
__decorate([
    query('#fileInput')
], EtoolsFile.prototype, "fileInputEl", void 0);
EtoolsFile = __decorate([
