...
import { adminIcon, apdIcon, dashIcon, externalIcon, famIcon, fmIcon, pmpIcon, gPDIcon, ecnIcon, prpIcon, pseaIcon, tripsIcon, unppIcon, ampIcon, menuIcon, rssIcon, storageIcon } from './app-selector-icons';
...
(function (Applications) {
    ...
    Applications["ECN"] = "ecn";
    Applications["PRP"] = "prp";
    ...
    Applications["RSS"] = "administration";
...
let AppSelector = class AppSelector extends LitElement {
    ...
    getPresetAllowedApps(user) {
        ...
        if (!!user._partner_staff_member || this.hasVisibilityByPartnerGroups(user) || this.showGPD(user)) {
    ...
    showGPD(user) {
        ...
        return !user.is_unicef_user && user.show_gpd && ((_a = user.organization) === null || _a === void 0 ? void 0 : _a.is_government);
    }
    hasVisibilityByPartnerGroups(user) {
        var _a;
        const partnersGroups = ['IP Viewer', 'IP Admin', 'IP Editor', 'IP Authorized Officer'];
        return (_a = user === null || user === void 0 ? void 0 : user.groups) === null || _a === void 0 ? void 0 : _a.some((g) => partnersGroups.includes(g.name));
    }
};
// language=css
