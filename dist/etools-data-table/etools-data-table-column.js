 ...
 */
let EtoolsDataTableColumn = class EtoolsDataTableColumn extends LitElement {
    render() {
        // language=HTML
        return html `
      <style>
...
], EtoolsDataTableColumn.prototype, "selected", void 0);
__decorate([
    property({ type: String, reflect: true, attribute: 'direction' })
], EtoolsDataTableColumn.prototype, "direction", void 0);
__decorate([
    property({ type: String, reflect: true, attribute: 'field' })
], EtoolsDataTableColumn.prototype, "field", void 0);
EtoolsDataTableColumn = __decorate([
    customElement('etools-data-table-column')
], EtoolsDataTableColumn);
export { EtoolsDataTableColumn };
